...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema countriesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://com.example.soapservice");
    ...
    public Jaxb2Marshaller marshaller() {
        ...
        marshaller.setContextPath("com.example.soapservice.calc");
        return marshaller;
    }

    @Bean
    public CalcClient client(Jaxb2Marshaller marshaller) {
